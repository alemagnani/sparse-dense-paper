...
\item \textbf{IVF:} Inverted file-based approximate search (FAISS). Documents clustered using k-means. We sweep over ($n_{\text{lists}}$, $n_{\text{probes}}$) pairs.
...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{figures/home_id_npnl.png}}
\centerline{\includegraphics[width=\columnwidth]{figures/home_rare_npnl.png}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{figures/home_standard_dim.png}}
\centerline{\includegraphics[width=\columnwidth]{figures/msmarco_standard_dim.png}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{figures/flat_dim_home_id.png}}
\centerline{\includegraphics[width=\columnwidth]{figures/flat_dim_home_rare.png}}
...
\end{document} N. Reimers and I. Gurevych, ``Sentence-BERT: Sentence embeddings using Siamese BERT-networks,'' in Proc. Conf. Empirical Methods Natural Language Process., 2019, pp. 3982--3992.
