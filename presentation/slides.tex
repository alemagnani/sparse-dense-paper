...
\begin{frame}{The recall--latency trade-off changes shape}
  \centering
  \includegraphics[width=0.94\textwidth]{figures/pareto_recall_vs_latency.png}

  \vspace{-0.4em}
  {\footnotesize HNSW efSearch sweep (standard FAISS recipe $M{=}16$, $\textrm{efC}{=}200$) vs.\ Flat (red square). Red region = strictly Pareto-dominated by Flat.}
\end{frame}
